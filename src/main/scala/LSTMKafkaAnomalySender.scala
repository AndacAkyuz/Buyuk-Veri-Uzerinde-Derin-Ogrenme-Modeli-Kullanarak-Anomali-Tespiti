...
object LSTMKafkaAnomalySender {
  def main(args: Array[String]): Unit = {
    ...
    val pythonScript = "D:\\Scala Deneme\\proje\\untitled3\\predict_with_tf_model.py"
    val modelPath = "D:\\Scala Deneme\\proje\\untitled3\\lstm_model_smote.h5"
    val dataPath = "D:\\Scala Deneme\\proje\\untitled3\\annthyroid_21feat_normalised.csv"
